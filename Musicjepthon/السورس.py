...
async def restart(client, m: Message):
    await m.delete()
    T_8_T_T = await m.reply("1")
    await T_8_T_T.edit("2")
    await T_8_T_T.edit("3")
    await T_8_T_T.edit("4")
    await T_8_T_T.edit("5")
    await T_8_T_T.edit("6")
    await T_8_T_T.edit("7")
    await T_8_T_T.edit("8")
    await T_8_T_T.edit("9")
    await T_8_T_T.edit("**تم اعادة تشغيل سورس دايموند ميوزك بنجاح ✓**")
